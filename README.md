# Extended-weapon-display

Allows users to set their weapon display offset well beyond the standard limits for all games within the Master Chief Collection for both Steam and Windows Store versions.
